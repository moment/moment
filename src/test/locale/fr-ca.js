...
test('strict day of month ordinal parsing', function (assert) {
    assert.ok(
        moment('2014 01 1er', 'YYYY MM Do', true).isValid(),
        'strict parsing accepts 1er'
    );
    assert.ok(
        moment('2014 01 2', 'YYYY MM Do', true).isValid(),
        'strict parsing accepts a cardinal day'
    );
    assert.ok(
        moment('2014 01 2e', 'YYYY MM Do', true).isValid(),
        'strict parsing keeps accepting the previous ordinal form'
    );
});

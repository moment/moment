...
test('parse strict no dots', function (assert) {
    var tests = 'januar jan_februar feb_mart mar_april apr_maj maj_juni jun_juli jul_august aug_septembar sep_oktobar okt_novembar nov_decembar dec'.split('_'), i;
    function equalTest(input, mmm, i) {
        assert.equal(moment(input, mmm, true).month(), i, input + ' should be month ' + (i + 1));
    }
    for (i = 0; i < 12; i++) {

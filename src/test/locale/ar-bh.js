...
test('parse', function (assert) {
    var tests = 'يناير:يناير_فبراير:فبراير_مارس:مارس_أبريل:أبريل_ماي:مايو_يونيو:يونيو_يوليو:يوليو_أوت:أوت_سبتمبر:سبتمبر_أكتوبر:أكتوبر_نوفمبر:نوفمبر_ديسمبر:ديسمبر'.split(
            '_'
        ),
        i;
...
test('format month', function (assert) {
    var expected = 'يناير يناير_فبراير فبراير_مارس مارس_أبريل أبريل_ماي مايو_يونيو ؤ يوليو_أوت أوت_سبتمبر سبتمبر_أكتوبر أكتوبر_نوفمبر نوفمبر_ديسمبر ديسمبر'.split(
            '_'
        ),
        i;
...
// locale-specific
test('ar-bh strict mode parsing works', function (assert) {
    var m, formattedDate;
    m = moment().locale('ar-bh');
    formattedDate = m.format('l');
    assert.equal(
        moment.utc(formattedDate, 'l', 'ar-bh', false).isValid(),
        true,
        'Non-strict parsing works'
    );
    assert.equal(
        moment.utc(formattedDate, 'l', 'ar-bh', true).isValid(),
        true,

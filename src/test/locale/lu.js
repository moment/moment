...
test('parse', function (assert) {
    var tests =
            'Januar Jan._Februar Feb._Mäerz Mäerz_Abrëll Abr._Mee Mee_Juni Juni_Juli Juli_August Aug._September Sep._Oktober Okt._November Nov._Dezember Dez.'.split(
                '_'
            ),
        i;
...
test('format', function (assert) {
    var a = [
            [
                ...
                'Sonndeg, 14. Februar 2010, 3:25:50 pm',
            ],
            ['ddd, hA', 'So., 3PM'],
            ...
            ['LLLL', 'Sonndeg, 14. Februar 2010 15:25'],
            ['l', '14.2.2010'],
            ['ll', '14. Feb. 2010'],
...
test('calendar last week', function (assert) {
    ...
    for (i = 2; i < 7; i++) {
        ...
        assert.equal(
            m.calendar(),
            m.format('[leschten] dddd [um] LT [Auer]'),
            'Today + ' + i + ' days current time'
        );
        m.hours(0).minutes(0).seconds(0).milliseconds(0);
        assert.equal(

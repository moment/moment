...
moment().add(1, 'hours').fromNow();

const day = new Date(2011, 9, 16);
const dayWrapper = moment(day);
const otherDay = moment(new Date(2020, 3, 7));

const day1 = moment(1318781876406);
const day2 = moment.unix(1318781876);
const day3 = moment("Dec 25, 1995");
const day4 = moment("12-25-1995", "MM-DD-YYYY");
const day5 = moment("12-25-1995", ["MM-DD-YYYY", "YYYY-MM-DD"]);
const day6 = moment("05-06-1995", ["MM-DD-YYYY", "DD-MM-YYYY"]);
const now = moment();
const day7 = moment([2010, 1, 14, 15, 25, 50, 125]);
const day8 = moment([2010]);
const day9 = moment([2010, 6]);
const day10 = moment([2010, 6, 10]);
const array = [2010, 1, 14, 15, 25, 50, 125];
const day11 = moment(Date.UTC.apply({}, array));
const day12 = moment.unix(1318781876);
...
const a2 = moment.utc([2011, 0, 1, 8]);
a.hours();
a.local();
a.hours();
...
m.hours();
m.add(1, 'days').hours();
const m2 = moment(new Date(2011, 2, 12, 5, 0, 0));
m2.hours();
m2.add(24, 'hours').hours();
...
const getMilliseconds: number = moment().milliseconds();
const getSeconds: number = moment().seconds();
const getMinutes: number = moment().minutes();
const getHours: number = moment().hours();
const getDate: number = moment().date();
const getDay: number = moment().day();
const getMonth: number = moment().month();
const getQuater: number = moment().quarter();
const getYear: number = moment().year();

moment().hours(0).minutes(0).seconds(0).milliseconds(0);

const a3 = moment([2011, 0, 1, 8]);
a3.hours();
a3.utc();
a3.hours();

const a4 = moment([2010, 1, 14, 15, 25, 50, 125]);
...
const a5 = moment([2007, 0, 29]);
const b5 = moment([2007, 0, 28]);
a5.from(b5);

const a6 = moment([2007, 0, 29]);
const b6 = moment([2007, 0, 28]);
a6.from(b6);
a6.from([2007, 0, 28]);
...
const a7 = moment();
const b7 = moment("10-10-1900", "MM-DD-YYYY");
a7.from(b7);
...
const a8 = moment([2007, 0, 29]);
const b8 = moment([2007, 0, 28]);
a8.diff(b8) ;
a8.diff(b8, 'days');
a8.diff(b8, 'years');
...
const globalLang = moment();
const localLang = moment();
...
const adur = moment.duration(3, 'd');
const bdur = moment.duration(2, 'd');

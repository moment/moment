...
test('day setter', function(assert) {
    ...
    assert.equal(
        moment(a)
            ...
            .date(),
        12,
        'set from saturday to wednesday'
    );
    ...
    assert.equal(
        moment(a)
            ...
            .date(),
        15,
        'set from wednesday to saturday'
    );
    assert.equal(
        moment(a)
            .day(3)

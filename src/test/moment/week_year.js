...
test('week year setter works under different locales', function (assert) {
    moment.locale('de');
    assert.equal(moment.utc('2016-01-01', moment.ISO_8601, true).weekYear(2015).format('gggg-MM-DD dd'), '2016-01-01 Fr', '2016-01-01 to 2015');

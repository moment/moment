...
Moment.js is now a legacy project in maintenance mode. For smaller , optimized and modern alternatives, please refer [Project Status](https://momentjs.com/docs/#/-project-status/) in the docs.
\
*Thank you.*

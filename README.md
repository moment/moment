...
Moment.js is now a legacy project: For more optimized, smaller and modern alternative, please refer [Project Status](https://momentjs.com/docs/#/-project-status/) in the docs.

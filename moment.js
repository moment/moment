...
(function (undefined) {
    ...
    ************************************/
    ...
    var moment,
        ...
        parseTokenWord = /[aApP]\.?[mM]\.?|[0-9]*[a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i, // any word (or two) characters or numbers including two/three word month in arabic.
    ...
    ************************************/
    ...
    function addTimeToArrayFromToken(token, input, config) {
        ...
        case 'A' :
            ...
            config._isPm = (normalized === 'pm' || normalized == 'p.m.');
            break;
        // 24 HOUR

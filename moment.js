...
(function (Date, undefined) {
    ...
    // Here are all the helper functions that are not specific to instances of
    // the moment library.
    ...
    function makeGetterAndSetter(moment, name, key) {
    ...
    function makeDurationGetter(moment, name) {
        moment.duration.fn[name] = function () {
            return this._data[name];
        };
    }

    function makeDurationAsGetter(moment, name, factor) {
    ...
    // TODO: document why this exists at all
    function instantiateLibrary() {
        ...
        moment.lang('en', englishLanguageDefinition);
        ...
        for (i = 0; i < proxyGettersAndSetters.length; i ++) {
            makeGetterAndSetter(moment, proxyGettersAndSetters[i].toLowerCase(), proxyGettersAndSetters[i]);
        }

        // add shortcut for year (uses different syntax than the getter/setter 'year' == 'FullYear')
        makeGetterAndSetter(moment, 'year', 'FullYear');
        ...
        for (i in unitMillisecondFactors) {
            if (unitMillisecondFactors.hasOwnProperty(i)) {
                makeDurationAsGetter(moment, i, unitMillisecondFactors[i]);
                makeDurationGetter(moment, i.toLowerCase());
            }
        }

        makeDurationAsGetter(moment, 'Weeks', 6048e5);

        moment.instantiateLibrary = instantiateLibrary;

        return moment;
    }

    defaultMoment = instantiateLibrary();

    // CommonJS module is defined
    if (hasModule) {
        module.exports = defaultMoment;
    }
    /*global ender:false */

...
describe('locale:az', () => {
    ...
    test('suffix', () => {
        expect(moment(30000).from(0), 'prefix').toBe('bir neçə saniyə sonra');
        expect(moment(0).from(30000), 'suffix').toBe('bir neçə saniyə əvvəl');
    });
    ...
    test('calendar next week', () => {
        ...
        for (i = 2; i < 7; i++) {
            ...
            ).toBe(m.format('[gələn həftə] dddd [saat] LT'));
    ...
    test('calendar last week', () => {
        ...
        for (i = 2; i < 7; i++) {
            ...
            expect(
                m.calendar(),
                'Today - ' + i + ' days beginning of day'
            ).toBe(m.format('[keçən həftə] dddd [saat] LT'));
            m.hours(23).minutes(59).seconds(59).milliseconds(999);
            expect(m.calendar(), 'Today - ' + i + ' days end of day').toBe(
                m.format('[keçən həftə] dddd [saat] LT')
            );

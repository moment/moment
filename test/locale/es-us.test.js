...
import '../../src/locale/es-us';

describe('locale:es-us', () => {
    setupLocaleTests('es-us');
    ...
    test('calendar day', () => {
        ...
        ).toBe('mañana a las 12:00 PM');
        expect(
            moment(a).add({ d: 1, h: -1 }).calendar(),
            'tomorrow minus 1 hour'
        ).toBe('mañana a las 11:00 AM');
        expect(
            moment(a).subtract({ h: 1 }).calendar(),
            'Now minus 1 hour'
        ).toBe('hoy a las 11:00 AM');
        expect(
            moment(a).subtract({ d: 1 }).calendar(),
            'yesterday at the same time'
        ).toBe('ayer a las 12:00 PM');
    });
    ...
    test('test lenient month parsing', () => {
        expect(

...
describe('locale:da', () => {
    ...
    test('suffix', () => {
        expect(moment(30000).from(0), 'prefix').toBe('om få sekunder');
        expect(moment(0).from(30000), 'suffix').toBe('få sekunder siden');
    });
    ...
    test('fromNow', () => {
        ...
        expect(moment().add({ d: 5 }).fromNow(), 'in 5 days').toBe('om 5 dage');
    });

...
import '../../src/locale/tzm-latn';

describe('locale:tzm-latn', () => {
    setupLocaleTests('tzm-latn');
    ...
    test('suffix', () => {
        expect(moment(30000).from(0), 'prefix').toBe('dadkh s yan imik');
        expect(moment(0).from(30000), 'suffix').toBe('yan imik');
    });

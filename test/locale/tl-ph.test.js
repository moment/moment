...
import '../../src/locale/tl-ph';

describe('locale:tl-ph', () => {
    setupLocaleTests('tl-ph');
    ...
    test('same next week', () => {
        ...
        for (i = 2; i < 7; i++) {
            ...
            ).toBe(m.format('LT [sa susunod na] dddd'));
    ...
    test('same last week', () => {
        ...
        for (i = 2; i < 7; i++) {
            ...
            expect(
                m.calendar(),
                'Today - ' + i + ' days beginning of day'
            ).toBe(m.format('LT [noong nakaraang] dddd'));
            m.hours(23).minutes(59).seconds(59).milliseconds(999);
            expect(m.calendar(), 'Today - ' + i + ' days end of day').toBe(
                m.format('LT [noong nakaraang] dddd')
            );

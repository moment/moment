...
describe('locale:me', () => {
    ...
    test('suffix', () => {
        expect(moment(30000).from(0), 'prefix').toBe('za nekoliko sekundi');
        expect(moment(0).from(30000), 'prefix').toBe('prije nekoliko sekundi');
    });

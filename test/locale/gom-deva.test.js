...
import '../../src/locale/gom-deva';

describe('locale:gom-deva', () => {
    setupLocaleTests('gom-deva');
    ...
    test('format', () => {
        var a = [
                ...
                [
                    'LLLL',
                    'आयतार, फेब्रुवारीच्या 14वेर, 2010, दनपारां 3:25 वाजतां',
                ],
                ['l', '14-2-2010'],
                ['ll', '14 फेब्रु. 2010'],
    ...
    test('suffix', () => {
        expect(moment(30000).from(0), 'prefix').toBe('थोडया सॅकंडांनी');
        expect(moment(0).from(30000), 'suffix').toBe('थोडे सॅकंड आदीं');
    });
    ...
    test('fromNow', () => {
        ...
        expect(moment().add({ d: 5 }).fromNow(), 'in 5 days').toBe('5 दिसांनी');
    });
    ...
    test('calendar day', () => {
        ...
        ).toBe('फाल्यां दनपारां 12:00 वाजतां');
        expect(
            moment(a).subtract({ h: 1 }).calendar(),
            'Now minus 1 hour'
        ).toBe('आयज सकाळीं 11:00 वाजतां');
        expect(
            moment(a).subtract({ d: 1 }).calendar(),
            'yesterday at the same time'
        ).toBe('काल दनपारां 12:00 वाजतां');
    });

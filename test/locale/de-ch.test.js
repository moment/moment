...
describe('locale:de-ch', () => {
    ...
    test('suffix', () => {
        expect(moment(30000).from(0), 'prefix').toBe('in ein paar Sekunden');
        expect(moment(0).from(30000), 'suffix').toBe('vor ein paar Sekunden');
    });
    ...
    test('calendar day', () => {
        ...
        ).toBe('morgen um 12:00 Uhr');
        expect(
            moment(a).subtract({ h: 1 }).calendar(),
            'Now minus 1 hour'
        ).toBe('heute um 11:00 Uhr');
        expect(
            moment(a).subtract({ d: 1 }).calendar(),
            'yesterday at the same time'
        ).toBe('gestern um 12:00 Uhr');
    });
    ...
    test('calendar last week', () => {
        ...
        for (i = 2; i < 7; i++) {
            ...
            expect(
                m.calendar(),
                'Today + ' + i + ' days beginning of day'
            ).toBe(m.format('[letzten] dddd [um] LT [Uhr]'));
            m.hours(23).minutes(59).seconds(59).milliseconds(999);
            expect(m.calendar(), 'Today + ' + i + ' days end of day').toBe(
                m.format('[letzten] dddd [um] LT [Uhr]')
            );
    ...
    test('duration humanize week threshold', () => {
        expect(

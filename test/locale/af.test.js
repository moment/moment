...
describe('locale:af', () => {
    ...
    test('suffix', () => {
        expect(moment(30000).from(0), 'prefix').toBe("oor 'n paar sekondes");
        expect(moment(0).from(30000), 'suffix').toBe("'n paar sekondes gelede");
    });
    ...
    test('fromNow', () => {
        ...
        expect(moment().add({ d: 5 }).fromNow(), 'in 5 days').toBe('oor 5 dae');
    });
    ...
    test('calendar day', () => {
        ...
        expect(
            ...
            'Now minus 1 hour'
        ).toBe('Vandag om 11:00');
        expect(
            moment(a).subtract({ d: 1 }).calendar(),
            'yesterday at the same time'
        ).toBe('Gister om 12:00');
    });

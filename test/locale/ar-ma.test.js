...
import '../../src/locale/ar-ma';

describe('locale:ar-ma', () => {
    setupLocaleTests('ar-ma');
    ...
    test('fromNow', () => {
        ...
        expect(moment().add({ d: 5 }).fromNow(), 'in 5 days').toBe('في 5 أيام');
    });
    ...
    test('calendar day', () => {
        ...
        ).toBe('غدا على الساعة 12:00');
        expect(
            moment(a).subtract({ h: 1 }).calendar(),
            'Now minus 1 hour'
        ).toBe('اليوم على الساعة 11:00');
        expect(
            moment(a).subtract({ d: 1 }).calendar(),
            'yesterday at the same time'
        ).toBe('أمس على الساعة 12:00');
    });

...
describe('locale:gl', () => {
    ...
    test('suffix', () => {
        expect(moment(30000).from(0), 'prefix').toBe('nuns segundos');
        expect(moment(0).from(30000), 'suffix').toBe('hai uns segundos');
    });
    ...
    test('now from now', () => {
        ...
        ).toBe('hai uns segundos');
    });

    test('fromNow', () => {
        expect(moment().add({ s: 30 }).fromNow(), 'nuns segundos').toBe(
            'nuns segundos'
        );
    ...
    test('regression tests', () => {
        ...
        expect(lastWeek.calendar(), "1 o'clock bug").toBe(

...
describe('locale:vi', () => {
    ...
    test('suffix', () => {
        expect(moment(30000).from(0), 'prefix').toBe('vài giây tới');
        expect(moment(0).from(30000), 'suffix').toBe('vài giây trước');
    });
    ...
    test('calendar day', () => {
        ...
        ).toBe('Ngày mai lúc 12:00');
        expect(
            moment(a).subtract({ h: 1 }).calendar(),
            'Now minus 1 hour'
        ).toBe('Hôm nay lúc 11:00');
        expect(
            moment(a).subtract({ d: 1 }).calendar(),
            'yesterday at the same time'
        ).toBe('Hôm qua lúc 12:00');
    });
    ...
    test('calendar next week', () => {
        ...
        for (i = 2; i < 7; i++) {
            ...
            ).toBe(m.format('dddd [tuần tới lúc] LT'));
    ...
    test('calendar last week', () => {
        ...
        for (i = 2; i < 7; i++) {
            ...
            expect(
                m.calendar(),
                'Today - ' + i + ' days beginning of day'
            ).toBe(m.format('dddd [tuần trước lúc] LT'));
            m.hours(23).minutes(59).seconds(59).milliseconds(999);
            expect(m.calendar(), 'Today - ' + i + ' days end of day').toBe(
                m.format('dddd [tuần trước lúc] LT')
            );

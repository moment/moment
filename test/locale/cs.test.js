...
describe('locale:cs', () => {
    ...
    test('suffix', () => {
        expect(moment(30000).from(0), 'prefix').toBe('za pár sekund');
        expect(moment(0).from(30000), 'suffix').toBe('před pár sekundami');
    });
    ...
    test('fromNow (future)', () => {
        ...
        expect(moment().add({ d: 1 }).fromNow(), 'in a day').toBe('za den');
        expect(moment().add({ d: 3 }).fromNow(), 'in 3 days').toBe('za 3 dny');
        expect(moment().add({ d: 10 }).fromNow(), 'in 10 days').toBe(
            'za 10 dní'
        );
        expect(moment().add({ M: 1 }).fromNow(), 'in a month').toBe('za měsíc');

...
import '../../src/locale/gom-latn';

describe('locale:gom-latn', () => {
    setupLocaleTests('gom-latn');
    ...
    test('suffix', () => {
        expect(moment(30000).from(0), 'prefix').toBe('thoddea sekondamni');
        expect(moment(0).from(30000), 'suffix').toBe('thodde sekond adim');
    });
    ...
    test('fromNow', () => {
        ...
        expect(moment().add({ d: 5 }).fromNow(), 'in 5 days').toBe('5 disamni');
    });
    ...
    test('calendar day', () => {
        ...
        ).toBe('Faleam donparam 12:00 vazta');
        expect(
            moment(a).subtract({ h: 1 }).calendar(),
            'Now minus 1 hour'
        ).toBe('Aiz sokallim 11:00 vazta');
        expect(
            moment(a).subtract({ d: 1 }).calendar(),
            'yesterday at the same time'
        ).toBe('Kal donparam 12:00 vazta');
    });

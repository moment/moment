...
describe('locale:sr-cyrl', () => {
    ...
    test('suffix', () => {
        expect(moment(30000).from(0), 'prefix').toBe('за неколико секунди');
        expect(moment(0).from(30000), 'prefix').toBe('пре неколико секунди');
    });
    ...
    test('fromNow', () => {
        ...
        expect(moment().add({ d: 5 }).fromNow(), 'in 5 days').toBe('за 5 дана');
    });

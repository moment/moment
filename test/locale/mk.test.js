...
describe('locale:mk', () => {
    ...
    test('suffix', () => {
        expect(moment(30000).from(0), 'prefix').toBe('за неколку секунди');
        expect(moment(0).from(30000), 'suffix').toBe('пред неколку секунди');
    });
    ...
    test('fromNow', () => {
        ...
        expect(moment().add({ d: 5 }).fromNow(), 'in 5 days').toBe('за 5 дена');
    });

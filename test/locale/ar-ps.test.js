...
import '../../src/locale/ar-ps';

describe('locale:ar-ps', () => {
    setupLocaleTests('ar-ps');
    ...
    test('suffix', () => {
        expect(moment(30000).from(0), 'prefix').toBe('في ثوان');
        expect(moment(0).from(30000), 'suffix').toBe('منذ ثوان');
    });
    ...
    test('fromNow', () => {
        ...
        expect(moment().add({ d: 5 }).fromNow(), 'in 5 days').toBe('في ٥ أيام');
    });
    ...
    test('calendar day', () => {
        ...
        ).toBe('غدا على الساعة ١٢:٠٠');
        expect(
            moment(a).subtract({ h: 1 }).calendar(),
            'Now minus 1 hour'
        ).toBe('اليوم على الساعة ١١:٠٠');
        expect(
            moment(a).subtract({ d: 1 }).calendar(),
            'yesterday at the same time'
        ).toBe('أمس على الساعة ١٢:٠٠');
    });
    ...
    test('calendar next week', () => {
        ...
        for (i = 2; i < 7; i++) {
            ...
            ).toBe(m.format('dddd [على الساعة] LT'));
    ...
    test('weeks year starting sunday formatted', () => {
        expect(moment([2011, 11, 31]).format('w ww wo'), '2011 11 31').toBe(
            '٥٣ ٥٣ ٥٣'
        );
        expect(moment([2012, 0, 6]).format('w ww wo'), '2012 0 6').toBe(
            '١ ٠١ ١'
        );
        expect(moment([2012, 0, 7]).format('w ww wo'), '2012 0 7').toBe(
            '١ ٠١ ١'
        );
        expect(moment([2012, 0, 13]).format('w ww wo'), '2012 0 13').toBe(
            '٢ ٠٢ ٢'
        );
        expect(moment([2012, 0, 14]).format('w ww wo'), '2012 0 14').toBe(
            '٢ ٠٢ ٢'
        );
    });
});

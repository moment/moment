...
describe('locale:pt-br', () => {
    ...
    test('suffix', () => {
        expect(moment(30000).from(0), 'prefix').toBe('em poucos segundos');
        expect(moment(0).from(30000), 'prefix').toBe('há poucos segundos');
    });
    ...
    test('fromNow', () => {
        ...
        expect(moment().add({ d: 5 }).fromNow(), 'in 5 days').toBe('em 5 dias');
    });
    ...
    test('calendar next week', () => {
        ...
        for (i = 2; i < 7; i++) {
            ...
            expect(m.calendar(), 'Today + ' + i + ' days at 00:00').toBe(
                m.format('dddd [à] LT')
            );
            m.hours(1);
            expect(m.calendar(), 'Today + ' + i + ' days at 01:00').toBe(
                m.format('dddd [à] LT')
            );
            m.hours(2);
            expect(m.calendar(), 'Today + ' + i + ' days at 02:00').toBe(
                m.format('dddd [às] LT')
            );

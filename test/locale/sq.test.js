...
describe('locale:sq', () => {
    ...
    test('meridiem', () => {
        ...
        expect(moment([2011, 2, 23, 12, 0]).format('A'), 'noon').toBe('MD');
    });
    ...
    test('suffix', () => {
        expect(moment(30000).from(0), 'prefix').toBe('në disa sekonda');
        expect(moment(0).from(30000), 'suffix').toBe('disa sekonda më parë');
    });
    ...
    test('fromNow', () => {
        ...
        expect(moment().add({ d: 5 }).fromNow(), 'in 5 days').toBe('në 5 ditë');
    });
    ...
    test('calendar last week', () => {
        ...
        for (i = 2; i < 7; i++) {
            ...
            expect(
                m.calendar(),
                'Today - ' + i + ' days beginning of day'
            ).toBe(m.format('dddd [e kaluar në] LT'));
            m.hours(23).minutes(59).seconds(59).milliseconds(999);
            expect(m.calendar(), 'Today - ' + i + ' days end of day').toBe(
                m.format('dddd [e kaluar në] LT')
            );

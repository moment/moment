var moment = require('../../moment');
    ...
    /***************************************************************
      Montenegrin tests (me) | Miodrag Nikač miodrag@restartit.me
    ***************************************************************/
...
exports['locale:me'] = {
    ...
    'from' : function (test) {
        ...
        test.equal(start.from(moment([2007, 1, 28]).add({d: 345}), true), 'godina',     '345 days = a year');
        test.equal(start.from(moment([2007, 1, 28]).add({d: 548}), true), '2 godine',       '548 days = 2 years');
        test.equal(start.from(moment([2007, 1, 28]).add({y: 1}), true),   'godina',     '1 year = a year');
    ...
    'suffix' : function (test) {
        ...
        test.equal(moment(0).from(30000), 'prije nekoliko sekundi', 'prefix');
        test.done();
    },
    ...
    'calendar day' : function (test) {
        ...
        test.equal(moment(a).add({d: 1}).calendar(),       'sjutra u 2:00',  'tomorrow at the same time');

...
describe('locale:zh-hk', () => {
    setupLocaleTests('zh-hk');
    ...
    test('suffix', () => {
        expect(moment(30000).from(0), 'prefix').toBe('幾秒後');
    ...
    test('fromNow', () => {
        ...
        expect(moment().add({ d: 5 }).fromNow(), 'in 5 days').toBe('5 天後');
    });
    ...
    test('meridiem', () => {
        ...
        expect(moment([2011, 2, 23, 11, 59]).format('a'), 'before noon').toBe(
            '上午'
        );
        expect(moment([2011, 2, 23, 12, 0]).format('a'), 'noon').toBe('中午');
        expect(moment([2011, 2, 23, 12, 1]).format('a'), 'after noon').toBe(
            '下午'
        );
        ...
        expect(moment([2011, 2, 23, 12, 0]).format('A'), 'noon').toBe('中午');
        expect(moment([2011, 2, 23, 12, 1]).format('A'), 'afternoon').toBe(
            '下午'
        );
        expect(moment([2011, 2, 23, 18, 0]).format('A'), 'night').toBe('晚上');
    });

...
import '../../src/locale/tzm';

describe('locale:tzm', () => {
    setupLocaleTests('tzm');
    ...
    test('suffix', () => {
        expect(moment(30000).from(0), 'prefix').toBe('ⴷⴰⴷⵅ ⵙ ⵢⴰⵏ ⵉⵎⵉⴽ');
        expect(moment(0).from(30000), 'suffix').toBe('ⵢⴰⵏ ⵉⵎⵉⴽ');
    });

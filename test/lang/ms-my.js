...
exports["lang:ms-my"] = {
    ...
    "format" : function(test) {
        ...
        var a = [
                ['dddd, MMMM Do YYYY, h:mm:ss a',      'Ahad, Februari 14th 2010, 3:25:50 pm'],
                ['ddd, hA',                            'Ahd, 3PM'],
                ['M Mo MM MMMM MMM',                   '2 2nd 02 Februari Feb'],
                ['YYYY YY',                            '2010 10'],
                ['D Do DD',                            '14 14th 14'],
                ['d do dddd ddd dd',                   '0 0th Ahad Ahd Ah'],
    ...
    "calendar day" : function(test) {
        ...
        test.equal(moment(a).calendar(),                     "Hari ini pada pukul 2:00 AM",     "hari ini pada waktu yang sama");
        test.equal(moment(a).add({ m: 25 }).calendar(),      "Hari ini pada pukul 2:25 AM",     "Sekarang tambah 25 minit");
        test.equal(moment(a).add({ h: 1 }).calendar(),       "Hari ini pada pukul 3:00 AM",     "Sekarang tambah 1 jam");
        test.equal(moment(a).add({ d: 1 }).calendar(),       "Esok pada pukul 2:00 AM",  "esok pada waktu yang sama");
        test.equal(moment(a).subtract({ h: 1 }).calendar(),  "Hari ini pada pukul 1:00 AM",     "Sekarang tolak 1 jam");
        test.equal(moment(a).subtract({ d: 1 }).calendar(),  "Semalam pada pukul 2:00 AM", "semalam pada waktu yang sama");
    ...
    "calendar next week" : function(test) {
        ...
        for (i = 2; i < 7; i++) {
            m = moment().add({ d: i });
            test.equal(m.calendar(),       m.format('dddd [at] LT'),  "Hari ini + " + i + " hari waktu sekarang");
            m.hours(0).minutes(0).seconds(0).milliseconds(0);
            test.equal(m.calendar(),       m.format('dddd [at] LT'),  "Hari ini + " + i + " hari permulaan hari");
            m.hours(23).minutes(59).seconds(59).milliseconds(999);
            test.equal(m.calendar(),       m.format('dddd [at] LT'),  "Hari ini + " + i + " hari tamat hari");
        }
        test.done();
    },
    ...
    "calendar last week" : function(test) {
        ...
        for (i = 2; i < 7; i++) {
            ...
            test.equal(m.calendar(),       m.format('[last] dddd [at] LT'),  "Hari ini - " + i + " hari waktu sekarang");
            m.hours(0).minutes(0).seconds(0).milliseconds(0);
            test.equal(m.calendar(),       m.format('[last] dddd [at] LT'),  "Hari ini - " + i + " hari permulaan hari");
            m.hours(23).minutes(59).seconds(59).milliseconds(999);
            test.equal(m.calendar(),       m.format('[last] dddd [at] LT'),  "Hari ini - " + i + " hari tamat hari");
        }
        test.done();
    },
    ...
    "calendar all else" : function(test) {
        ...
        test.equal(weeksAgo.calendar(),       weeksAgo.format('L'),  "1 minggu lalu");
    ...
    "weeks year starting sunday" : function(test) {
        ...
        test.equal(moment([2012, 0,  7]).week(), 1, "Jan  7 2012 sepatutnya minggu 1");
        test.equal(moment([2012, 0,  8]).week(), 2, "Jan  8 2012 sepatutnya minggu 2");
        test.equal(moment([2012, 0, 14]).week(), 2, "Jan 14 2012 sepatutnya minggu 2");
    ...
    "weeks year starting monday" : function(test) {
        ...
        test.equal(moment([2007,  0,  7]).week(), 2, "Jan  7 2007 sepatutnya minggu 2");
        test.equal(moment([2007,  0, 13]).week(), 2, "Jan 13 2007 sepatutnya minggu 2");
        test.equal(moment([2007,  0, 14]).week(), 3, "Jan 14 2007 sepatutnya minggu 3");
    ...
    "weeks year starting tuesday" : function(test) {
        ...
        test.equal(moment([2007, 11, 30]).week(), 1, "Dec 30 2007 sepatutnya minggu 1");
        ...
        test.equal(moment([2008,  0,  6]).week(), 2, "Jan  6 2008 sepatutnya minggu 2");
        test.equal(moment([2008,  0, 12]).week(), 2, "Jan 12 2008 sepatutnya minggu 2");
        test.equal(moment([2008,  0, 13]).week(), 3, "Jan 13 2008 sepatutnya minggu 3");
    ...
    "weeks year starting wednesday" : function(test) {
        ...
        test.equal(moment([2002, 11, 29]).week(), 1, "Dec 29 2002 sepatutnya minggu 1");
        ...
        test.equal(moment([2003,  0,  5]).week(), 2, "Jan  5 2003 sepatutnya minggu 2");
        test.equal(moment([2003,  0, 11]).week(), 2, "Jan 11 2003 sepatutnya minggu 2");
        test.equal(moment([2003,  0, 12]).week(), 3, "Jan 12 2003 sepatutnya minggu 3");
    ...
    "weeks year starting thursday" : function(test) {
        ...
        test.equal(moment([2008, 11, 28]).week(), 1, "Dec 28 2008 sepatutnya minggu 1");
        ...
        test.equal(moment([2009,  0,  4]).week(), 2, "Jan  4 2009 sepatutnya minggu 2");
        test.equal(moment([2009,  0, 10]).week(), 2, "Jan 10 2009 sepatutnya minggu 2");
        test.equal(moment([2009,  0, 11]).week(), 3, "Jan 11 2009 sepatutnya minggu 3");
    ...
    "weeks year starting friday" : function(test) {
        ...
        test.equal(moment([2009, 11, 27]).week(), 1, "Dec 27 2009 sepatutnya minggu 1");
        ...
        test.equal(moment([2010,  0,  3]).week(), 2, "Jan  3 2010 sepatutnya minggu 2");
        test.equal(moment([2010,  0,  9]).week(), 2, "Jan  9 2010 sepatutnya minggu 2");
        test.equal(moment([2010,  0, 10]).week(), 3, "Jan 10 2010 sepatutnya minggu 3");
    ...
    "weeks year starting saturday" : function(test) {
        ...
        test.equal(moment([2010, 11, 26]).week(), 1, "Dec 26 2010 sepatutnya minggu 1");
        test.equal(moment([2011,  0,  1]).week(), 1, "Jan  1 2011 sepatutnya minggu 1");
        test.equal(moment([2011,  0,  2]).week(), 2, "Jan  2 2011 sepatutnya minggu 2");
        test.equal(moment([2011,  0,  8]).week(), 2, "Jan  8 2011 sepatutnya minggu 2");
        test.equal(moment([2011,  0,  9]).week(), 3, "Jan  9 2011 sepatutnya minggu 3");
    ...
    "weeks year starting sunday format" : function(test) {
        ...
        test.equal(moment([2012, 0,  1]).format('w ww wo'), '1 01 1st', "Jan  1 2012 sepatutnya minggu 1");
        test.equal(moment([2012, 0,  7]).format('w ww wo'), '1 01 1st', "Jan  7 2012 sepatutnya minggu 1");
        test.equal(moment([2012, 0,  8]).format('w ww wo'), '2 02 2nd', "Jan  8 2012 sepatutnya minggu 2");
        test.equal(moment([2012, 0, 14]).format('w ww wo'), '2 02 2nd', "Jan 14 2012 sepatutnya minggu 2");
        test.equal(moment([2012, 0, 15]).format('w ww wo'), '3 03 3rd', "Jan 15 2012 sepatutnya minggu 3");

...
exports["lang:el"] = {
    "parse" : function(test) {
        test.expect(96);
        moment.lang('el');
        var tests = 'Ιανουάριος Ιαν_Φεβρουάριος Φεβ_Μάρτιος Μάρ_Απρίλιος Απρ_Μάιος Μάι_Ιούνιος Ιούν_Ιούλιος Ιούλ_Αύγουστος Αυγ_Σεπτέμβριος Σεπ_Οκτώβριος Οκτ_Νοέμβριος Νοέ_Δεκέμβριος Δεκ'.split("_");
        var i;
    ...
    "format" : function(test) {
        ...
        moment.lang('el');
        var a = [
                ['dddd, MMMM Do YYYY, h:mm:ss a',      'Κυριακή, 14 Φεβρουαρίου 2010, 3:25:50 μμ'],
                ['ddd, hA',                            'Κυρ, 3ΜΜ'],
                ['M Mo MM MMMM MMM',                   '2 2nd 02 Φεβρουάριος Φεβ'],
                ['YYYY YY',                            '2010 10'],
                ['D Do DD',                            '14 14th 14'],
                ['d do dddd ddd dd',                   '0 0th Κυριακή Κυρ Κυ'],
                ...
                ['s ss',                               '50 50'],
                ['a A',                                'μμ ΜΜ'],
                ['t\\he DDDo \\d\\ay of t\\he ye\\ar', 'η 45η μέρα του χρόνου'],
                ['L',                                  '14/02/2010'],
                ['LL',                                 '14 Φεβρουαρίου 2010'],
                ['LLL',                                '14 Φεβρουαρίου 2010 3:25 PM'],
                ['LLLL',                               'Κυριακή, 14 Φεβρουαρίου 14 2010 3:25 PM']
            ],
    ...
    "format month" : function(test) {
        test.expect(12);
        moment.lang('el');
        var expected = 'Ιανουάριος Ιαν_Φεβρουάριος Φεβ_Μάρτιος Μάρ_Απρίλιος Απρ_Μάιος Μάι_Ιούνιος Ιούν_Ιούλιος Ιούλ_Αύγουστος Αυγ_Σεπτέμβριος Σεπ_Οκτώβριος Οκτ_Νοέμβριος Νοέ_Δεκέμβριος Δεκ'.split("_");
        var i;
    ...
    "suffix" : function(test) {
        test.expect(2);
        moment.lang('el');
        test.equal(moment(30000).from(0), "σε μερικά δευτερόλεπτα",  "prefix");
        test.equal(moment(0).from(30000), "μερικά δευτερόλεπτα πριν", "suffix");
        test.done();
    },

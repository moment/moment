...
exports["lang:mk"] = {
    ...
    "parse" : function(test) {
        test.expect(96);
        var tests = 'јануари јан_февруари фев_март мар_април апр_мај мај_јуни јун_јули јул_август авг_септември сеп_октомври окт_ноември ное_декември дек'.split("_");
        var i;
    ...
    "format" : function(test) {
        test.expect(22);
        var a = [
                ['dddd, MMMM Do YYYY, h:mm:ss a',      'недела, февруари 14-ти 2010, 3:25:50 pm'],
                ['ddd, hA',                            'нед, 3PM'],
                ['M Mo MM MMMM MMM',                   '2 2-ри 02 февруари фев'],
                ['YYYY YY',                            '2010 10'],
                ['D Do DD',                            '14 14-ти 14'],
                ['d do dddd ddd dd',                   '0 0-ев недела нед нд'],
                ...
                ['LLLL',                               'недела, 14 февруари 2010 3:25'],
                ['l',                                  '14.2.2010'],
                ['ll',                                 '14 фев 2010'],
    ...
    "format month" : function(test) {
        test.expect(12);
        var expected = 'јануари јан_февруари фев_март мар_април апр_мај мај_јуни јун_јули јул_август авг_септември сеп_октомври окт_ноември ное_декември дек'.split("_");
        var i;

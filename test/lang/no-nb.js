...
exports["lang:no-nb"] = {
    ...
    "from" : function(test) {
        ...
        test.equal(start.from(moment([2007, 1, 28]).add({s:45}), true),  "minutt",       "45 seconds = a minute");
        test.equal(start.from(moment([2007, 1, 28]).add({s:89}), true),  "minutt",       "89 seconds = a minute");
        ...
        test.equal(start.from(moment([2007, 1, 28]).add({d:26}), true),  "måneder",      "26 days = a month");
        test.equal(start.from(moment([2007, 1, 28]).add({d:30}), true),  "måneder",      "30 days = a month");
        test.equal(start.from(moment([2007, 1, 28]).add({d:45}), true),  "måneder",      "45 days = a month");
        ...
        test.equal(start.from(moment([2007, 1, 28]).add({M:1}), true),   "måneder",      "1 month = a month");

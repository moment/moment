...
exports["lang:my"] = {
   ...
   "parse" : function (test) {
    ...
    "format" : function (test) {
        test.expect(22);
        var a = [
                ['dddd, MMMM Do YYYY, h:mm:ss a',      'တနင်္ဂနွေ, ဖေဖော်ဝါရီ ၁၄ ၂၀၁၀, ၃:၂၅:၅၀ ညနေ'],
                ['ddd, hA',                            'နွေ, ညနေ ၃နာရီ'],
                ...
                ['s ss',                               '၅၀ ၅၀'],
                ['a A',                                'ညနေ ညနေ'],
                ['[the] DDDo [day of the year]',       'နှစ် တစ်နှစ် ရဲ့ ၄၅ ရက်မြောက်'],
                ['L',                                  '၁၄၊၀၂၊၂၀၁၀'],
                ['LL',                                 '၁၄ ဖေဖော်ဝါရီ ၂၀၁၀'],
                ['LLL',                                'ဖေဖော်ဝါရီ ၂၀၁၀ ၁၅:၂၅'],
                ['LLLL',                               'တနင်္ဂနွေ၊ ဖေဖော်ဝါရီ ၁၄ ၂၀၁၀ ၁၅:၂၅'],
                ['l',                                  '၁၄၊၂၊၂၀၁၀'],
                ['ll',                                 '၁၄ ဖေ ၂၀၁၀'],
...
/*
    ...
    "calendar day" : function (test) {
        ...
        test.equal(moment(a).add({ m: 25 }).calendar(),      "ယေန႔ ၀၂ : ၂၅ တြင္",      "ယခုမွ ၂၅ မိနစ္ေပါင္းထည့္");
        test.equal(moment(a).add({ h: 1 }).calendar(),       "ယေန႔ ၀၃ : ၀၀ တြင္",      "ယခုမွ ၁ နာရီေပါင္းထည့္");

...
exports["lang:my"] = {
   ...
   "parse" : function (test) {
        test.expect(96);
        var tests = 'ဇန်နဝါရီ ဇန်_ဖေဖော်ဝါရီ ဖေ_မတ် မတ်_ဧပြီ ပြီ_မေ မေ_ဇွန် ဇွန်_ဇူလိုင် လိုင်_သြဂုတ် သြ_စက်တင်ဘာ စက်_အောက်တိုဘာ အောက်_နိုဝင်ဘာ နို_ဒီဇင်ဘာ ဒီ'.split("_"), i;
    ...
    "format month" : function (test) {
        test.expect(12);
        var expected = 'ဇန်နဝါရီ ဇန်_ဖေဖော်ဝါရီ ဖေ_မတ် မတ်_ဧပြီ ပြီ_မေ မေ_ဇွန် ဇွန်_ဇူလိုင် လိုင်_သြဂုတ် သြ_စက်တင်ဘာ စက်_အောက်တိုဘာ အောက်_နိုဝင်ဘာ နို_ဒီဇင်ဘာ ဒီ'.split("_"),i;
    ...
    "format week" : function (test) {
        test.expect(7);
        var expected = 'တနင်္ဂနွေ နွေ နွေ_တနင်္လာ လာ လာ_အင်္ဂါ င်္ဂါ င်္ဂါ_ဗုဒ္ဓဟူး ဟူး ဟူး_ကြာသပတေး ကြာ ကြာ_သောကြာ သော သော_စနေ နေ နေ'.split("_"), i;
    ...
    "from" : function (test) {
        ...
        var start = moment([2007, 1, 28]);
     	test.equal(start.from(moment([2007, 1, 28]).add({s: 44}), true),  "စက္ကန်.အနည်းငယ်", "၄၄ စက္ကန်. = စက္ကန်.အနည်းငယ်");
        test.equal(start.from(moment([2007, 1, 28]).add({s: 45}), true),  "တစ်မိနစ်",      "၄၅ စက္ကန်. = တစ်မိနစ်");
        test.equal(start.from(moment([2007, 1, 28]).add({s: 89}), true),  "တစ်မိနစ်",      "၈၉ စက္ကန်. = တစ်မိနစ်");
        test.equal(start.from(moment([2007, 1, 28]).add({s: 90}), true),  "၂ မိနစ်",     "၉၀ စက္ကန်. =  ၂ မိနစ်");
        test.equal(start.from(moment([2007, 1, 28]).add({m: 44}), true),  "၄၄ မိနစ်",    "၄၄ မိနစ် = ၄၄ မိနစ်");
        test.equal(start.from(moment([2007, 1, 28]).add({m: 45}), true),  "တစ်နာရီ",       "၄၅ မိနစ် = ၁ နာရီ");
        test.equal(start.from(moment([2007, 1, 28]).add({m: 89}), true),  "တစ်နာရီ",       "၈၉ မိနစ် = တစ်နာရီ");
        test.equal(start.from(moment([2007, 1, 28]).add({m: 90}), true),  "၂ နာရီ",       "မိနစ် ၉၀= ၂ နာရီ");
        ...
        test.equal(start.from(moment([2007, 1, 28]).add({h: 22}), true),  "တစ်ရက်",         "၂၂ နာရီ =တစ်ရက်");
        test.equal(start.from(moment([2007, 1, 28]).add({h: 35}), true),  "တစ်ရက်",         "၃၅ နာရီ =တစ်ရက်");
        test.equal(start.from(moment([2007, 1, 28]).add({h: 36}), true),  "၂ ရက်",        "၃၆ နာရီ = ၂ ရက်");
        test.equal(start.from(moment([2007, 1, 28]).add({d: 1}), true),   "တစ်ရက်",         "၁ ရက်= တစ်ရက်");
        test.equal(start.from(moment([2007, 1, 28]).add({d: 5}), true),   "၅ ရက်",        "၅ ရက် = ၅ ရက်");
        test.equal(start.from(moment([2007, 1, 28]).add({d: 25}), true),  "၂၅ ရက်",       "၂၅ ရက်= ၂၅ ရက်");
        test.equal(start.from(moment([2007, 1, 28]).add({d: 26}), true),  "တစ်လ",       "၂၆ ရက် = တစ်လ");
        test.equal(start.from(moment([2007, 1, 28]).add({d: 30}), true),  "တစ်လ",       "ရက် ၃၀ = တစ်လ");
        test.equal(start.from(moment([2007, 1, 28]).add({d: 45}), true),  "တစ်လ",       "၄၅ ရက် = တစ်လ");
        test.equal(start.from(moment([2007, 1, 28]).add({d: 46}), true),  "၂ လ",      "၄၆ ရက် = ၂ လ");
        test.equal(start.from(moment([2007, 1, 28]).add({d: 74}), true),  "၂ လ",      "၇၅ ရက်= ၂ လ");
        test.equal(start.from(moment([2007, 1, 28]).add({d: 76}), true),  "၃ လ",      "၇၆ ရက် = ၃ လ");
        test.equal(start.from(moment([2007, 1, 28]).add({M: 1}), true),   "တစ်လ",       "၁ လ = တစ်လ");
        test.equal(start.from(moment([2007, 1, 28]).add({M: 5}), true),   "၅ လ",      "၅ လ = ၅ လ");
        test.equal(start.from(moment([2007, 1, 28]).add({d: 344}), true), "၁၁ လ",     "၃၄၄ ရက် = ၁၁ လ");
        test.equal(start.from(moment([2007, 1, 28]).add({d: 345}), true), "တစ်နှစ်",        "၃၄၅ ရက် = တစ်နှစ်");
        test.equal(start.from(moment([2007, 1, 28]).add({d: 547}), true), "တစ်နှစ်",        "၅၇၄ ရက် = တစ်နှစ်");
        test.equal(start.from(moment([2007, 1, 28]).add({d: 548}), true), "၂ နှစ်",       "၅၄၈ ရက် = ၂ နှစ်");
        test.equal(start.from(moment([2007, 1, 28]).add({y: 1}), true),   "တစ်နှစ်",        "၁ နှစ် = တစ်နှစ်");
        test.equal(start.from(moment([2007, 1, 28]).add({y: 5}), true),   "၅ နှစ်",       "၅ နှစ် = ၅ နှစ်");
        test.done();
    },
    ...
    "fromNow" : function (test) {
        test.expect(2);
        test.equal(moment().add({s: 30}).fromNow(), "လာမည့် စက္ကန်.အနည်းငယ် မှာ", "လာမည့် စက္ကန်.အနည်းငယ် မှာ");
        test.equal(moment().add({d: 5}).fromNow(), "လာမည့် ၅ ရက် မှာ", "လာမည့် ၅ ရက် မှာ");
        test.done();
    },
    ...
    "calendar day" : function (test) {
        ...
        test.equal(moment(a).add({ m: 25 }).calendar(),      "ယနေ. ၀၂:၂၅ မှာ",      "ယခုမှ ၂၅ မိနစ်ပေါင်းထည့်");
        test.equal(moment(a).add({ h: 1 }).calendar(),       "ယနေ. ၀၃:၀၀ မှာ",      "ယခုမှ ၁ နာရီပေါင်းထည့်");
        test.equal(moment(a).add({ d: 1 }).calendar(),       "မနက်ဖြန် ၀၂:၀၀ မှာ",   "မနက်ဖြန် ဒီအချိန်");
        test.equal(moment(a).subtract({ h: 1 }).calendar(),  "ယနေ. ၀၁:၀၀ မှာ",      "ယခုမှ ၁ နာရီနှုတ်");
        test.equal(moment(a).subtract({ d: 1 }).calendar(),  "မနေ.က ၀၂:၀၀ မှာ",  "မနေ.က ဒီအချိန်");
        test.done();
    },

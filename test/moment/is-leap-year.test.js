...
import { isLeapYear } from '../../src/lib/utils/is-leap-year';
    ...
    test('leap years', () => {
        var tests = [
            ...
            { year: 4, expected: true, description: '4 was a leap year' },
            {
                year: 100,
                expected: false,
                description: '100 was not a leap year',
            },
            ...
            },
            {
                year: 2024,
                expected: true,
                description: '2024 will be a leap year',
            },
            {
                year: 3448,
                expected: true,
                description: '3448 will be a leap year',
            },
            {
                year: 4000,
                expected: true,
                description: '4000 will be a leap year',
            },
            {
                year: NaN,
                expected: false,
        ...
        each(tests, function (testCase) {
            ...
            expect(actual, testCase.description).toBe(testCase.expected);
        });
    });
});

...
describe('is same or before', () => {
    test('is same or before without units', () => {
        ...
        expect(m.isSameOrBefore(m), 'moments are the same as themselves').toBe(
            true
        );
        expect(+m, 'isSameOrBefore second should not change moment').toBe(
            +mCopy
        );
    });
    ...
    test('is same or before year', () => {
        ...
        expect(+m, 'isSameOrBefore year should not change moment').toBe(+mCopy);
    });
    ...
    test('is same or before month', () => {
        ...
        expect(
            m.isSameOrBefore(
                moment(new Date(2012, 2, 6, 7, 8, 9, 10)),
                'month'
            ),
            'year is later'
        ).toBe(true);
        expect(
            m.isSameOrBefore(
                moment(new Date(2010, 2, 6, 7, 8, 9, 10)),
                'month'
            ),
            'year is earlier'
        ).toBe(false);
        ...
        expect(+m, 'isSameOrBefore month should not change moment').toBe(
            +mCopy
        );
    });
    ...
    test('is same or before day', () => {
        ...
        expect(+m, 'isSameOrBefore day should not change moment').toBe(+mCopy);
    });
    ...
    test('is same or before hour', () => {
        ...
        expect(
            m.isSameOrBefore(
                moment(new Date(2010, 12, 2, 3, 8, 9, 10)),
                'hour'
            ),
            'month is earlier'
        ).toBe(false);
        ...
        expect(+m, 'isSameOrBefore hour should not change moment').toBe(+mCopy);
    });
    ...
    test('is same or before minute', () => {
        ...
        expect(
            m.isSameOrBefore(
                moment(new Date(2011, 1, 2, 3, 4, 0, 0)),
                'minute'
            ),
        ...
        expect(+m, 'isSameOrBefore minute should not change moment').toBe(
            +mCopy
        );
    });
    ...
    test('is same or before second', () => {
        ...
        expect(
            m.isSameOrBefore(
                moment(new Date(2011, 1, 2, 3, 4, 5, 0)),
                'second'
            ),
    ...
    test('is same or before millisecond', () => {
        ...
        expect(+m, 'isSameOrBefore millisecond should not change moment').toBe(
            +mCopy
        );
    });
    ...
    test('is same with invalid moments', () => {
        ...
        expect(m.isSameOrBefore(invalid, 'year'), 'invalid moment year').toBe(
            false
        );
        expect(m.isSameOrBefore(invalid, 'month'), 'invalid moment month').toBe(
            false
        );
        expect(m.isSameOrBefore(invalid, 'day'), 'invalid moment day').toBe(
            false
        );
        expect(m.isSameOrBefore(invalid, 'hour'), 'invalid moment hour').toBe(
            false
        );
        expect(
